    ...
    <div class="container-fluid">
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            ...
            ?>  
              ...
              <li class="active"><a href="<?php echo base_url();?>users/add_admin">Add Admin</a></li>
        ...
        <div class="span9">
          <div class="row-fluid">
            <div class="page-header">
              <h1>User <small>Admin info</small></h1>
            </div>
            <form class="form-horizontal" id="add_user" method="POST" action="<?php echo base_url();?>users/add_admin">
               <?php 
                if ($message == null){
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          ...
          <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="admin_list">
   ...
   <script type="text/javascript">
      $(document).ready(function() {
        ...
        $('#admin_list').dataTable({
          ...
          "bProcessing" : true,
          "bServerSide" : false,
          "sAjaxSource": '<?php echo base_url();?>users/list_admin'
        });
